@php
    ...
    // Parse date for Second event (Ngunduh Mantu / Resepsi)
    $eventDate2 = isset($schedule[1]['date']) ? \Carbon\Carbon::parse($schedule[1]['date']) : $eventDate;
@endphp
<!DOCTYPE html>
...
<head>
    ...
    <meta name="description"
        content="tema undangan syari tanpa foto - Undangan Online: Undangan digital modern untuk pernikahan dan acara spesial lainnya. Gratis coba dulu, bayar belakangan!">
    <meta itemprop="image" content="/themes/islamic-wedding/islamic-wedding.jpg">
    <!-- Open Graph / Facebook -->
    ...
    <meta property="og:description"
        content="tema undangan syari tanpa foto - Undangan Online: Undangan digital modern untuk pernikahan dan acara spesial lainnya. Gratis coba dulu, bayar belakangan!">
    <meta property="og:image" content="/themes/islamic-wedding/islamic-wedding.jpg">
    ...
    <script type="application/ld+json">
        {
          ...
          "image": "/themes/islamic-wedding/islamic-wedding.jpg",
...
<body>
    <main id="app">
        ...
        <audio id="music" loop autoplay>
            <source src="/musics/Murottal-SuratArRumAyat21.mp3">
        </audio>
        <!-- end music -->
                ...
                <div class="h-100 w-100 d-flex align-items-center justify-content-center">
                    <div class="canvas not-open  ">
                                ...
                                <ul class="satumomen_list">
                                    <li class="satumomen_slide satumomen_cover">
                                        <div class="container-mobile cover"
                                            style="background-image: url(/themes/islamic-wedding/bg.webp); ;">
                                            <div class="frame">
                                                <img class="frame-tl w-100 frame-2 animate__animated animate__fadeInDown animate__slower"
                                                    src="/themes/islamic-wedding/tm.webp" alt="frame">
                                                <img class="frame-br w-100 animate__animated animate__fadeInUp animate__slower"
                                                    src="/themes/islamic-wedding/bm.webp" alt="frame">
                                                <img class="frame-tl frame-1 h-100 animate__animated animate__fadeInTopLeft animate__slow"
                                                    src="/themes/islamic-wedding/left.webp" alt="frame">
                                                <img class="frame-tr frame-1 h-100 animate__animated animate__fadeInTopRight animate__slow"
                                                    src="/themes/islamic-wedding/right.webp" alt="frame">
                                                <img class="frame-out frame-bl h-100 animate__animated animate__slideOutLeft animate__slower"
                                                    src="/themes/islamic-wedding/pintu-left.webp" alt="frame"
                                                    style="z-index:9">
                                                <img class="frame-out frame-br h-100 animate__animated animate__slideOutRight animate__slower"
                                                    src="/themes/islamic-wedding/pintu-right.webp" alt="frame"
                                                    style="z-index:9">
                                            </div>
                                            <div class="d-flex justify-content-center align-items-center"
                                                style="height:calc(100% + 60px);width:calc(100% + 60px);background-size:cover;margin:-30px;padding:30px;">
                                                <div style="width:100%;">
                                                    <div class="text-center editable animate__animated animate__fadeInDown animate__slower mb-4"
                                                        style="font-size:16px;">Sunday<br />12rd March</div>
                                                    <div
                                                        class="d-flex justify-content-center animate__animated animate__zoomIn animate__slower image-editable">
                                                        <div class="editable color-accent h3 mb-0 font-accent"
                                                            style="font-size:90px;transform:translate(10px, -10px);">E
                                                        </div>
                                                        <div class="editable color-accent h3 mb-0 font-accent"
                                                            style="font-size:90px;transform:translate(-10px, 10px);">K
                                                        </div>
                                                    </div>
                                                    <div
                                                        class="text-center animate__animated animate__fadeInUp animate__slower mb-5">
                                                        <div class="editable color-accent h3 mb-0 font-accent"
                                                            style="font-size:30px;">{{ strtoupper($couple['groom']) }} &amp; {{ strtoupper($couple['bride']) }}</div>
                                                        <div class="editable" style="font-size:15px;">SAVE THE DATE
                                                        </div>
                                                    </div>
                                                    <div class="text-center mx-auto" style="max-width:300px;">
                                                        <div
                                                            ...
                                                            <div id="guestNameSlot"
                                                                ...
                                                                style="font-size:16px;">Nama Tamu</div>
                                                        </div><button
                                    ...
                                    <li class="satumomen_slide">
                                        <div class="container-mobile "
                                            ...
                                            <div class="d-flex flex-column justify-content-center align-items-center"
                                                style="height:100%;">
                                                <div class="animate__animated animate__zoomIn animate__slower mb-4"
                                                    style="border:3px solid var(--inv-border);padding:0.1rem;border-radius:1.3rem;">
                                                    <div class="d-flex justify-content-center"
                                                        style="border:2px solid var(--inv-border);border-radius:1rem;max-width:65px;padding:20px 5px;">
                                                        <div class="editable color-accent h3 mb-0 font-accent"
                                                            style="font-size:40px;transform:translate(10px, -10px);">E
                                                        </div>
                                                        <div class="editable color-accent h3 mb-0 font-accent"
                                                            style="font-size:40px;transform:translate(-10px, 10px);">K
                                                        </div>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="text-center animate__animated animate__fadeInUp animate__slower"
                                                        ...
                                                        <div class="editable quotes mb-3"
                                                            style="font-size:14.4px;line-height:2;">Dan di antara
                                                            tanda-tanda kekuasaan-Nva ialah Dia menciptakan untukmu
                                                        ...
                                                        <div class="editable font-italic" style="font-size:14.4px;">
                                                            (Ar-Rum: 21)</div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="container-mobile "
                                            ...
                                            <div class="d-flex justify-content-center align-items-center"
                                                ...
                                                <div>
                                                    ...
                                                    <div class="editable text-center animate__animated animate__fadeInDown animate__fast"
                                                        style="font-size:14.4px;">Dengan memohon Rahmat<br />dan Ridho
                                                        Allah Subhanahu wa ta'ala kami bermaksud menyelenggarakan Akad
                                                        &amp; Resepsi<br />Pernikahan Putra-Putri kami</div>
                                                    <div class="mt-4">
                                                        <div class="text-center animate__animated animate__fadeInLeft animate__slower"
                                                            ...
                                                            <div class="editable color-accent h4 mb-2 font-weight-bold"
                                                                style="font-size:16px;color:rgb(164, 124, 28);">R
                                                                Hidayatullah</div>
                                                            <div class="editable" style="font-size:14.4px;">Putra
                                                                dari<br />Bapak Ir. H. Faisal Qamra<br />&amp; Ibu Dra.
                                                                Hj. Iin Indrayati</div>
                                                        </div>
                                                        <div class="my-3 editable text-center color-accent animate__animated animate__zoomIn animate__slower font-italic font-accent"
                                                            style="font-size:14px;color:rgb(164, 124, 28);">dengan</div>
                                                        <div class="text-center animate__animated animate__fadeInRight animate__slower"
                                                            style="position:relative;">
                                                            <div class="editable color-accent h4 mb-2 font-weight-bold"
                                                                style="font-size:16px;color:rgb(164, 124, 28);">Karina
                                                                Febriyan</div>
                                                            <div class="editable mb-1" style="font-size:14.4px;">Putri
                                                                dari<br />Bapak Kompol H. Heriyanto<br />&amp; Ibu Hj.
                                                                Emmi Ridarti S. H.</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div style="width:100%;">
                                                    ...
                                                    <div class="text-center mb-3">
                                                        ...
                                                        <div
                                                            ...
                                                            <div style="border-left:2px solid var(--inv-accent);border-right:2px solid var(--inv-accent);"
                                                                class="px-3">
                                                                <div class="editable"
                                                                    style="font-size:38px;line-height:1;">29</div>
                                                                <div class="editable" style="font-size:14.4px;">2023
                                                                </div>
                                                            </div>
                                                            <div class="editable" style="font-size:14.4px;width:100px;">
                                                                Oktober</div>
                                                        ...
                                                        <div class="editable animate__animated animate__fadeInDown animate__slower"
                                                            style="font-size:14.4px;">Pukul {{ $schedule[0]['time'] ?? $event['time'] }} WIB</div>
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <div class="editable font-weight-bold animate__animated animate__fadeInUp animate__slower"
                                                            style="font-size:14.4px;">{{ $schedule[0]['note'] ?? $event['location'] }}</div>
                                                        <div class="editable mb-4 animate__animated animate__fadeInUp animate__slower"
                                                            style="font-size:14.4px;">Jl.Batang Masang No.4A (Belakang
                                                            Balok) Kec. Aur Birugo Tigo Baleh, Kota Bukittingi -
                                                            Sumatera Barat</div><a
                                                            href="{{ $event['maps_url'] }}"
                                                            target="_blank"
                                                            class="link btn btn-primary rounded-pill animate__animated animate__fadeInUp animate__slower"
                                                            rel="noreferrer noopener">Link Google Maps</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div style="width:100%;">
                                                    ...
                                                    <div class="text-center mb-3">
                                                        ...
                                                        <div
                                                            ...
                                                            <div style="border-left:2px solid var(--inv-accent);border-right:2px solid var(--inv-accent);"
                                                                class="px-3">
                                                                <div class="editable"
                                                                    style="font-size:38px;line-height:1;">26</div>
                                                                <div class="editable" style="font-size:14.4px;">2023
                                                                </div>
                                                            </div>
                                                            <div class="editable" style="font-size:14.4px;width:100px;">
                                                        ...
                                                        <div class="editable animate__animated animate__fadeInDown animate__slower"
                                                            style="font-size:14.4px;">Pukul {{ $schedule[1]['time'] ?? '12:00 - Selesai' }} WIB</div>
                                                    ...
                                                    <div class="text-center">
                                                        <div class="editable font-accent color-accent animate__animated animate__fadeInUp animate__slower"
                                                            style="font-size:18px;">Lokasi Acara</div>
                                                        <div class="editable font-weight-bold animate__animated animate__fadeInUp animate__slower"
                                                            style="font-size:14.4px;">{{ $schedule[1]['note'] ?? $event['location'] }}
                                                        </div>
                                                        <div class="editable mb-4 animate__animated animate__fadeInUp animate__slower"
                                                            style="font-size:14.4px;">Jl.Karang Bolong, Cikoneng, Kec.
                                                            Anyar, Kab.Serang - Banten</div><a
                                                            href="{{ $event['maps_url'] }}"
                                                            target="_blank"
                                                            class="link btn btn-primary rounded-pill animate__animated animate__fadeInUp animate__slower"
                                                            rel="noreferrer noopener">Link Google Maps</a>
                                    ...
                                    <li class="satumomen_slide">
                                        <div class="container-mobile "
                                            ...
                                            <div class="d-flex flex-column justify-content-center align-items-center"
                                                ...
                                                <div style="width:100%;">
                                                    <div class="text-center color-accent h4 mb-4 editable animate__animated animate__fadeInDown animate__slow font-accent"
                                                    ...
                                                    <div class="countdown-wrapper mx-auto mb-5 d-flex flex-column animate__animated animate__fadeInUp animate__slower"
                                                        data-datetime="{{ $event['date_iso'] }}T{{ $event['time'] ?? '08:00' }}"
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="text-center">
                                                            ...
                                                            <button
                                                                ...
                                                                style="gap: 8px; font-size: 14px;">Kirim Ucapan
                                                                RSVP</button>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <li class="satumomen_slide">
                                        <div class="container-mobile "
                                            ...
                                            <div class="d-flex justify-content-center align-items-center"
                                                style="height:100%;">
                                                <div style="width:100%;">
                                                    <div class="editable text-center color-accent mb-3 animate__animated animate__fadeInDown animate__slow font-italic"
                                                        ...
                                                        <div class="p-1 mb-3 animate__animated animate__flipInX animate__slower"
                                                            ...
                                                            <div class="image-editable animate__animated animate__fadeInDown animate__slow"
                                                                ...
                                                                <img src="{{ $bg['cover'] }}"
                                                                    ...
                                                                    alt="111607-gallery-1695051852.png" /></div>
                                                        </div>
                                                        <div
                                                            class="text-center animate__animated animate__fadeInUp animate__slow">
                                                            <div class="editable color-accent font-weight-bold"
                                                                style="font-size:14.4px;">{{ strtoupper($event['location']) }}</div>
                                                            <div class="editable mb-3 font-italic"
                                                                style="font-size:12px;">T. Pajajaran Indah V,
                                                                Baranangsiang, Kola Bogor</div><a
                                                                href="{{ $event['maps_url'] }}"
                                                                target="_blank" rel="nofollow noreferrer noopener"
                                                                class="link btn btn-primary mb-4 animate__animated animate__fadeInUp animate__slow"
                                                                style="border-radius:0.3rem;">Petunjuk Ke Lokasi</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="container-mobile "
                                            ...
                                            <div class="d-flex justify-content-center align-items-center"
                                                ...
                                                <div style="width:100%;" class="text-center">
                                                    <div
                                                        class="editable font-latin color-accent h4 mb-4 animate__animated animate__fadeInDown animate__slower">
                                                        Live Streaming
                                                    </div>
                                                    <div
                                                        class="editable animate__animated animate__fadeInDown animate__slower">
                                                        Temui Kami secara virtual untuk menyaksikan acara pernikahan
                                                        kami yang InsyaAllah kan disiarkan langsung melalui akun
                                                        Instagram atau silakan join meeting melalui zoom berikut ini.
                                                    </div>
                                                    <div class="d-flex justify-content-center mt-3">
                                                        <div class="image-editable animate__animated animate__fadeInDown animate__slower m-2"
                                                            style="height:90px;width:90px;border-radius:10px;overflow:hidden;">
                                                            <img src="{{ $gallery[0] ?? $bg['cover'] }}"
                                                                style="width: 100%;height: 100%;object-fit: cover;"
                                                                alt="250027-gallery-ko8LACRrq8.png" />
                                                        </div>

                                                    </div><a href="{{ $event['zoom_url'] ?? 'https://zoom.us/' }}" target="_blank"
                                                        class="link btn btn-primary rounded-pill my-3 animate__animated animate__fadeInUp animate__slow"
                                                        rel="noreferrer noopener">Join Live Streaming</a>
                                                    <div class="editable animate__animated animate__fadeInUp animate__slower"
                                                        style="font-size:14.4px;">Zoom Meeting ID :
                                                        123456789<br />Password : Rahasia</div>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                        ...
                                        <div class="container-mobile "
                                            ...
                                            <div class="d-flex justify-content-center align-items-center"
                                                ...
                                                <div style="width:100%;" class="text-center">
                                                    ...
                                                    <div class="editable animate__animated animate__fadeInDown animate__slower"
                                                        style="font-size:14.4px;">Temui Kami secara virtual untuk
                                                        menyaksikan acara pernikahan kami yang InsyaAllah kan disiarkan
                                                        langsung melalui akun Instagram berikut:</div>
                                                    <div class="d-flex justify-content-center my-3">
                                                        <div class="image-editable animate__animated animate__fadeInDown animate__slower m-2"
                                                            style="height:90px;width:90px;border-radius:10px;overflow:hidden;">
                                                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Instagram_icon.png/2048px-Instagram_icon.png"
                                                                style="width: 100%;height: 100%;object-fit: cover;"
                                                                alt="2048px-Instagram_icon.png" />
                                                        </div>

                                                    </div>
                                                    <div>
                                                        <a href="https://instagram.com/{{ $couple['ig_groom'] ?? '' }}" target="_blank"
                                                            class="link btn btn-primary rounded-pill animate__animated animate__fadeInUp animate__slow"
                                                            rel="noreferrer noopener">Join Live {{ '@' . ($couple['ig_groom'] ?? 'groom_ig') }}</a>
                                                    </div>
                                                    <div>
                                                        <a href="https://instagram.com/{{ $couple['ig_groom'] ?? '' }}" target="_blank"
                                                            class="link btn btn-primary rounded-pill my-3 animate__animated animate__fadeInUp animate__slow"
                                                            rel="noreferrer noopener">Join Live {{ '@' . ($couple['ig_bride'] ?? 'bride_ig') }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="d-flex justify-content-center align-items-center"
                                                ...
                                                <div class="text-center" style="width:100%;">
                                                    <div class="editable color-accent h4 mb-4 animate__animated animate__fadeInDown animate__slower font-latin"
                                                        style="font-size:28.8px;">Instagram Filter</div>
                                                    <div class="editable animate__animated animate__fadeInDown animate__slower"
                                                        style="font-size:14.4px;">Gunakan instagram filter berikut
                                                        <br />untuk menambah kemeriahan acara</div>
                                                    <div class="d-flex px-3 justify-content-center mt-3">
                                                        <div class="image-editable animate__animated animate__fadeInDown animate__slower m-2"
                                                            style="height:300px;width:200px;border-radius:10px;overflow:hidden;">
                                                            <img src="/images/no-image.jpg"
                                                                style="width: 100%; height: 100%; object-fit: cover;"
                                                                alt="no-image.jpg" /></div>
                                                    </div><a href="{{ $event['ig_filter_url'] ?? 'https://www.instagram.com/' }}" target="_blank"
                                                        class="link btn btn-primary rounded-pill my-3 animate__animated animate__fadeInUp animate__slow"
                                                        rel="noreferrer noopener">Gunakan Filter</a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                                ...
                                                <div style="width:100%;" class="text-center">
                                                    ...
                                                    <div style="display:flex;gap:8px;">
                                                        <button
                                                            ...
                                                            style="max-width: 150px; margin: auto; font-size: 14.4px;"><i class="ph-fill ph-credit-card"></i>
                                                            Cashless</button>
                                                        <button
                                                            class="btn-gift btn btn-block btn-primary rounded-pill animate__animated animate__fadeInUp animate__slow"
                                                            style="max-width: 150px; margin: auto; font-size: 14.4px;"><i class="ph-fill ph-gift"></i>
                                                            Kirim Kado</button>
                                                    </div>
                                                    <div
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="text-center mb-2">
                                                            <div class="editable font-weight-bold h5 color-accent mb-2">
                                                                Kirim Kado</div>
                                                            <div class="editable mb-0">Anda dapat mengirim kado
                                                                ke:<br />{{ $couple['shipping_address'] ?? 'Jl. Wildan Sari 1 No 11 Banjarmasin Barat 70119' }}
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <li class="satumomen_slide">
                                        <div class="container-mobile "
                                            ...
                                            <div class="d-flex justify-content-center align-items-center"
                                                ...
                                                <div>
                                                    <div
                                                        class="font-latin text-center color-accent h4 mb-2 editable animate__animated animate__fadeInDown animate__slower">
                                                        Contact Person</div>
                                                    <div class="editable mb-4 text-center animate__animated animate__fadeInUp animate__slower"
                                                        style="font-size:14.4px;">Hubungi Contact Person kami jika ada
                                                        hal<br />yang ingin ditanyakan.</div>

                                                    <div
                                                        class="text-center animate__animated animate__fadeInUp animate__slower mb-4">
                                                        <div class="image-editable animate__animated animate__fadeInUp animate__slower"
                                                            style="height:100px;width:100px;margin:auto;border-radius:100%;overflow:hidden;margin-bottom:10px;">
                                                            <img src="{{ $bg['bride'] }}"
                                                                style="width: 100%;height: 100%;object-fit: cover;"
                                                                alt="23358-gallery-1666958913.jpg" />
                                                        </div>
                                                        <div class="editable color-accent h4 mb-2 animate__animated animate__fadeInUp animate__slower font-accent"
                                                            style="font-size:21.6px;">Karina</div>
                                                        <a class="link btn btn-primary rounded-pill animate__animated animate__fadeInUp animate__slower"
                                                            href="https://wa.me/628111111111" target="_blank"
                                                            rel="noreferrer noopener">WA 0812-2345-6789</a>
                                                    </div>
                                                    <div
                                                        ...
                                                        <div class="image-editable animate__animated animate__fadeInUp animate__slower"
                                                            ...
                                                            <img src="{{ $bg['groom'] }}"
                                                                style="width: 100%;height: 100%;object-fit: cover;"
                                                                alt="23358-gallery-1666958993.jpg" />
                                                        </div>
                                                        <div class="editable color-accent h4 mb-2 animate__animated animate__fadeInUp animate__slower font-accent"
                                                            style="font-size:21.6px;">Enda</div>
                                                        <a class="link btn btn-primary rounded-pill animate__animated animate__fadeInUp animate__slower"
                                                            href="https://wa.me/628111111111" target="_blank"
                                                            rel="noreferrer noopener">WA 0812-3456-7890</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li class="satumomen_slide">
                                        <div class="container-mobile "
                                            ...
                                            <div class="watermark d-flex flex-column align-items-center justify-content-center"
                                                style="height:100%;">
                                                <div style="border:3px solid var(--inv-border);padding:0.1rem;border-radius:1.3rem;"
                                                    class="animate__animated animate__zoomIn animate__slower mb-4">
                                                    <div class="d-flex justify-content-center"
                                                        style="border:2px solid var(--inv-border);border-radius:1rem;max-width:65px;padding:20px 5px;">
                                                        <div class="editable color-accent h3 mb-0 font-accent"
                                                            style="font-size:40px;transform:translate(10px, -10px);">E
                                                ...
                                                <div style="width:100%;">
                                                    <div class="text-center">
                                                        ...
                                                        <div class="editable mb-3 animate__animated animate__fadeInDown animate__slower"
                                                            style="font-size:14px;">Merupakan suatu kebahagiaan dan
                                                        ...
                                                        <div class="editable font-italic animate__animated animate__fadeInDown animate__slow"
                                                            style="font-size:14px;">Hormat Kami Yang Mengundang</div>

                                                        <div class="editable h4 color-accent animate__animated animate__fadeInDown animate__slow font-accent"
                                                            style="font-size:30px;">{{ $couple['groom'] }} &amp; {{ $couple['bride'] }}</div>
                        ...
                        <div class="floating-action d-flex align-items-end flex-column">
                            <a href="/chat?text=Saya+mau+order+undangan+digital+tema+Islamic+Wedding"
                ...
                <div class="modal-content" style="height:100%">
                    ...
                    <div class="text-center py-4 px-4">
                        ...
                        <div style="margin-bottom: 10px">
                            ...
                            <div>{{ request()->get('kpd', 'Tamu Undangan') }}</div>
                        </div>
                        <div style="margin-bottom: 10px">
                            <div style="color: #b2b2b2;">Grup</div>
                            <div>{{ request()->get('group', 'VIP') }}</div>
                        </div>
                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content p-4" style="height:100%">
                    ...
                    <rsvp-component
                        ...
                        :invitation_id="250027" name="{{ request()->get('kpd', 'Tamu Undangan') }}" code="" :replace="false" overlay="1"></rsvp-component>
                    <!-- rsvp form -->
        ...
        <div id="waterMark" class="mt-5" style="display: none">
            <div class="wm-music mt-3 text-center animate__animated animate__fadeInUp animate__slower animate__delay-1s"
                ...
                <div style="opacity: 0.5">Murottal - Surat Ar Rum Ayat 21</div>
            </div>
        </div>
    </main>
    <!-- illegal -->
