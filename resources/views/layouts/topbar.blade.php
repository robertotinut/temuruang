    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('dashboard') }}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ asset('assets/images/small-logo.png') }}" alt="" height="30">
                        <!-- <h3 class="m-0 text-primary mt-4">TR</h3> -->
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('assets/images/logo-2.png') }}" alt="" height="40">
                    </span>
                </a>

                <a href="{{ route('dashboard') }}" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ asset('assets/images/small-logo-white.png') }}" alt="" height="30">
                        <!-- <h3 class="m-0 text-primary mt-4">TR</h3> -->
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('assets/images/logo-2-white.png') }}" alt="" height="40">
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ Auth::user()->avatar ?? asset('assets/images/users/avatar-1.jpg') }}"
                        alt="Header Avatar">
