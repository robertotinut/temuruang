...
<div class="row">
    <div class="col-xl-8">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('master.packages.update', $package->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('max_guest') is-invalid @enderror" id="max_guest" name="max_guest" value="{{ old('max_guest', $package->max_guest) }}" min="0" placeholder="Kosongkan = Unlimited">
                                @error('max_guest')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('max_gallery') is-invalid @enderror" id="max_gallery" name="max_gallery" value="{{ old('max_gallery', $package->max_gallery) }}" min="0" placeholder="Kosongkan = Unlimited">
                                @error('max_gallery')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('max_template') is-invalid @enderror" id="max_template" name="max_template" value="{{ old('max_template', $package->max_template) }}" min="0" placeholder="Kosongkan = Unlimited">
                                @error('max_template')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
